...
public class InstallDB  {
	...
	public static void createDB(){
		try {
			Connection con = DriverManager.getConnection("jdbc:mysql://"+DB_HOST+":8181", DB_USER, DB_PASS);
	...
	public static void runSQL(String sql){
		try {
			Connection con = DriverManager.getConnection("jdbc:mysql://"+DB_HOST+":8181/"+DB_NAME, DB_USER, DB_PASS);
			PreparedStatement st = con.prepareStatement(sql);
			st.executeUpdate();
			con.close();
